...
namespace exercise7._3
{
    class Program
    {
        static void Main(string[] args)
        {
                ...
                // -	Arbeta vidare på övningen. Gör så att om användaren matar in något annat än ”J”, ”j”, ”n”, ”N” så 
                // skriver programmet ut ”Jag förstår inte!”.
            ...
            //Om inget ovan är sant, skriv ut "Jag förstår inte!?"          
            else
            {
